...
show_cdp_neighbors = [sw1_show_cdp_neighbors,r1_show_cdp_neighbors,r2_show_cdp_neighbors,r3_show_cdp_neighbors,r4_show_cdp_neighbors,r5_show_cdp_neighbors]
show_cdp_neighbors_detail = [sw1_show_cdp_neighbors_detail,r1_show_cdp_neighbors_detail,r2_show_cdp_neighbors_detail,r3_show_cdp_neighbors_detail,r4_show_cdp_neighbors_detail,r5_show_cdp_neighbors_detail]

for device in show_cdp_neighbors:
	a = device.split("\n")
	c = a[1].split(">") 
	network_devices [c[0]] = {}
	network_devices [c[0]]["adjacent_devices"] = []
	i = 5
	while (i <= (len(a)-2)):
		b = a[i].split(" ")
		network_devices [c[0]]["adjacent_devices"].append(b[0])
		i += 1
		
		
for device in show_cdp_neighbors_detail:
	a = device.split("-------------------------")
	a.pop(0)

	for text in a:
		b = text.split("Device ID: ")
		c = b[1].split("\n")
		d = c[2].split("IP address:")
		network_devices[c[0]]["ip"] = d[1]
		d = c[3].split("Platform: ")
		e = d[1].split(",")
		h = e[0].split(" ")
		network_devices[c[0]]["vendor"] = h[0]
		network_devices[c[0]]["model"] = h[1]
		f = e[1].split("Capabilities: ")
		g = f[1].split (" IGMP")
		if g[0] == "Router Switch":
			g[0] = "Router"
		if g[0] != "Router" and g[0] != "Switch":
			g[0] = "unknown"
		network_devices[c[0]]["device_type"] = g[0]
